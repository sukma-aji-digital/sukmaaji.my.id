        ...
        <div className="text-center">
          ...
          <div className="mb-6 sm:mb-8">
            <input
              ...
              className="w-full max-w-xs sm:max-w-md lg:max-w-lg mx-auto text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-center border-3 sm:border-4 border-gray-300 rounded-xl sm:rounded-2xl py-3 sm:py-4 lg:py-6 px-4 sm:px-6 lg:px-8 focus:border-blue-500 focus:outline-none focus:ring-2 sm:focus:ring-4 focus:ring-blue-200 transition-all duration-200 shadow-inner bg-gray-50 font-bold"
              autoComplete="off"
            />
          </div>
