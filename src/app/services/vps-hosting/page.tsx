...
export default function VPSHostingPage() {
  ...
  const useCases = [
    {
      ...
      description: "Host multiple websites dengan performa tinggi",
      icon: "fas fa-globe",
    },
    {
      title: "Application Server",
      description: "Deploy aplikasi web dan mobile backend",
      icon: "fas fa-server",
    },
    {
      title: "Database Server",
      description: "Host database MySQL, PostgreSQL, MongoDB",
      icon: "fas fa-database",
    },
    {
      title: "Development Environment",
      description: "Environment untuk development dan testing",
      icon: "fas fa-code",
    },
    {
      title: "Email Server",
      description: "Setup email server corporate yang professional",
      icon: "fas fa-envelope",
    },
    {
      title: "Backup Server",
      description: "Server backup untuk data critical business",
  ...
  const datacenterFeatures = [
    {
      ...
      description: "Infrastruktur datacenter berkelas enterprise dengan redundansi tinggi",
    },
    {
      title: "Multiple ISP",
      description: "Koneksi internet dari multiple ISP untuk uptime maksimal",
    },
    {
      title: "24/7 Security",
      description: "Keamanan fisik datacenter dengan monitoring 24/7",
    },
    {
      title: "Fire Suppression",
      description: "Sistem proteksi kebakaran untuk melindungi perangkat",
    },
  ];
  ...
  const operatingSystems = [
    ...
    { name: "Debian", icon: "fab fa-debian" },
    { name: "Windows", icon: "fab fa-windows" },
    { name: "RedHat", icon: "fab fa-redhat" },
    { name: "FreeBSD", icon: "fas fa-server" },
  ];
  ...
  return (
    <div className="min-h-screen bg-dark-400 pt-20">
      ...
      <section className="py-16 bg-gradient-to-br from-dark-300 to-dark-400">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Penyewaan Server VPS</h1>
            <p className="text-slate-dark text-lg mb-8 max-w-2xl mx-auto">
              Solusi hosting VPS berkualitas tinggi dengan performa optimal, uptime terjamin 99.9%,
              dan support 24/7 untuk kebutuhan bisnis digital Anda.
            </p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {useCases.map((useCase, index) => (
              ...
              >
                <i className={`${useCase.icon} text-accent text-3xl mb-4`}></i>
      ...
      <section className="py-16 bg-dark-300">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-white text-center mb-12">
            Operating System Yang Tersedia
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
            {operatingSystems.map((os, index) => (
              ...
              >
                <i className={`${os.icon} text-accent text-2xl mb-2`}></i>
                <p className="text-white font-medium">{os.name}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {datacenterFeatures.map((feature, index) => (
              <div key={index} className="bg-dark-300 p-6 rounded-xl border border-dark-100">
                ...
                <p className="text-slate-dark">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-r from-accent/20 to-accent/10 rounded-2xl p-8 md:p-12 text-center border border-accent/30">
            ...
            <p className="text-slate-dark mb-8 max-w-2xl mx-auto">
              Konsultasikan kebutuhan hosting Anda dengan tim ahli kami. Dapatkan rekomendasi paket
              VPS yang sesuai dengan budget dan requirement.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/#contact"
