            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {project.client && (
                    <div>
                      ...
                      <dd className="text-lg font-semibold text-gray-900 dark:text-white">{project.client}</dd>
                    </div>
                  )}
                  
                  <div>
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Category</dt>
                    <dd className="text-lg font-semibold text-gray-900 dark:text-white">{project.category}</dd>
                  </div>
                  
                  {project.year && (
                    <div>
                      <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Year</dt>
                      <dd className="text-lg font-semibold text-gray-900 dark:text-white">{project.year}</dd>
                    </div>
                  )}
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex gap-3">
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(project.title)}&url=${encodeURIComponent(`${process.env.NEXT_PUBLIC_SITE_URL}/projects/${project.slug}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`${process.env.NEXT_PUBLIC_SITE_URL}/projects/${project.slug}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${process.env.NEXT_PUBLIC_SITE_URL}/projects/${project.slug}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
